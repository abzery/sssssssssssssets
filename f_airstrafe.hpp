...
static void tick(uint64_t p) {
    ...
    wrf(jp + ASTR_JP_JUMP_MOVE_SPEED, s_air_strafe);
}
...
namespace {
static events::feature _f_airstrafe = {"airstrafe", nullptr, airstrafe::late, nullptr, nullptr, nullptr};
static struct _reg_airstrafe { _reg_airstrafe() { events::register_feature(_f_airstrafe); } } _r_airstrafe;
}
